...
/// State operator
pub open spec fn LState() -> { checkpoint_digest: Set<int>, commit_senders: Set<Set<int>>, checkpoint_seq: Set<int>, high_watermark: Set<int>, phase: int, request_digest: Set<int>, prepare_senders: Set<Set<int>>, low_watermark: Set<int>, seq_num: Set<int>, view: Set<int>, is_primary: Set<bool> } {
...
/// Constants operator
pub open spec fn LConstants() -> { f: Set<int>, checkpoint_interval: Set<int>, n: Set<int>, node_id: Set<int> } {
