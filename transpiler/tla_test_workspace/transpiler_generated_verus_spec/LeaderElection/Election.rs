...
pub open spec fn LNext(s: LState, c: LConstants, s_: int) -> bool {
    exists |node, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LDetectFailure(s, c, s, s_, c, node, sent_packets) || exists |node, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LStartElection(s, c, s, s_, c, node, sent_packets) || exists |node, sender, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LSendAnswer(s, c, s, s_, c, node, sender, sent_packets) || exists |node, responder, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LReceiveAnswer(s, c, s, s_, c, node, responder, sent_packets) || exists |node, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LSendCoordinator(s, c, s, s_, c, node, sent_packets) || exists |node, leader, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && (LReceiveCoordinator(s, c, s, s_, c, node, leader, sent_packets) || exists |node, sent_packets| (Seq(c.ElectionMessage).contains(sent_packets)) && LNodeFail(s, c, s, s_, c, node, sent_packets)))))))
}
