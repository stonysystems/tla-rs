...
/// State operator
pub open spec fn LState() -> { decided_val: Set<int>, proposer_bal: Set<int>, highest_accepted_bal: Set<int>, promised_bal: Set<int>, accepted_val: Set<int>, promises_rcvd: Set<Set<int>>, highest_accepted_val: Set<int>, accepted_bal: Set<int>, phase: int, proposed_val: Set<int>, accepts_rcvd: Set<Set<int>> } {
...
/// Constants operator
pub open spec fn LConstants() -> { node_id: Set<int>, quorum_size: Set<int>, acceptors: Set<Set<int>> } {
