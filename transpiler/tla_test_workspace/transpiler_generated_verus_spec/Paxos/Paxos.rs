...
pub open spec fn LRecvAccepted(s: LState, s_: LState, c: LConstants, a: int) -> bool {
    ((((((((((((((arbitrary::<int>() == 2508597854int) && Set::<int>::empty().contains(a)) && !Set::<int>::empty().contains(a)) && (Set::<int>::empty() == Set::<int>::empty().union(set![a]))) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == 2508597854int)) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>()))
}

/// Learn operator
pub open spec fn LLearn(s: LState, s_: LState, c: LConstants) -> bool {
    (((((((((((((arbitrary::<int>() == 2508597854int) && ((arbitrary::<Seq<int>>().len() as int) >= arbitrary::<int>())) && (arbitrary::<int>() == 8313578207int)) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>())) && (arbitrary::<int>() == arbitrary::<int>()))
}
