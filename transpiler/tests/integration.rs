...
fn test_d1_generated_verus_spec_compile_baseline() {
    ...
    // Baseline after 16.8.3d-2d-11:
    // D1 spec translation now infers generated-D1 helper return type shape
    // for obvious seq/set-producing expressions (e.g., IF SubSeq(...) ELSE s).
    assert_eq!(
        passed, 15,
