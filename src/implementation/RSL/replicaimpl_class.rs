...
// Types imported from generated types_gen (formerly from manual impl modules)
use crate::generated::RSL::types_gen::{CAcceptor, CExecutor, COutstandingOperation, CProposer, CIncompleteBatchTimer, CLearner};
