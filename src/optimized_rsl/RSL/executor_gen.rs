    ...
    { let result = if (contains(&s.constants.all.config.replica_ids, &inp.src) && (match &inp.msg {
        ...
        _  => {
            ...
            unreachable_value()
                ...
                let sent_packets = crate::optimized_rsl::RSL::broadcast_gen::CBroadcastToEveryone(&s.constants.all.config, &s.constants.my_index, &CMessage::CMessageAppStateRequest {
