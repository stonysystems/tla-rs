...
use crate::optimized_rsl::RSL::acceptor_gen::*;
use crate::optimized_rsl::RSL::broadcast_gen::CBroadcastToEveryone;
use crate::optimized_rsl::RSL::executor_gen::*;
use crate::optimized_rsl::RSL::learner_gen::*;
use crate::optimized_rsl::RSL::proposer_gen::*;
...
{
    { let r_proposer = crate::optimized_rsl::RSL::proposer_gen::CProposerInit(&c); let r_acceptor = crate::optimized_rsl::RSL::acceptor_gen::CAcceptorInit(&c); let r_learner = crate::optimized_rsl::RSL::learner_gen::CLearnerInit(&c); let r_executor = crate::optimized_rsl::RSL::executor_gen::CExecutorInit(&c); CReplica {
        constants: c.clone(),
...
pub exec fn CReplicaNextProcessInvalid_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
...
pub exec fn CReplicaNextProcessRequest_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcess1a_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcess1b_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcessStartingPhase2_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcess2a_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcess2b_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcessReply_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
ensures
...
pub exec fn CReplicaNextProcessAppStateSupply_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcessAppStateRequest_opt(s: &mut CReplica, received_packet: &CPacket) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextProcessHeartbeat_opt(s: &mut CReplica, received_packet: &CPacket, clock: &u64) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    received_packet.valid(),
...
pub exec fn CReplicaNextSpontaneousMaybeEnterNewViewAndSend1a_opt(s: &mut CReplica) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
ensures
    s.valid(),
...
pub exec fn CReplicaNextSpontaneousMaybeEnterPhase2_opt(s: &mut CReplica) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
ensures
    s.valid(),
...
pub exec fn CReplicaNextReadClockMaybeNominateValueAndSend2a_opt(s: &mut CReplica, clock: &CClockReading) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    clock.valid(),
ensures
...
pub exec fn CReplicaNextSpontaneousTruncateLogBasedOnCheckpoints_opt(s: &mut CReplica) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
ensures
    s.valid(),
...
pub exec fn CReplicaNextSpontaneousMaybeMakeDecision_opt(s: &mut CReplica) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
ensures
    s.valid(),
...
pub exec fn CReplicaNextSpontaneousMaybeExecute_opt(s: &mut CReplica) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
ensures
    s.valid(),
    ...
    match &s.executor.next_op_to_execute {
        COutstandingOperation::COutstandingOpKnown{v, ..} => {
            if cond2 && cond3 {
                ...
                let sent_packets = crate::optimized_rsl::RSL::executor_gen::CExecutorExecute_mut(&mut s.executor);
...
pub exec fn CReplicaNextReadClockMaybeSendHeartbeat_opt(s: &mut CReplica, clock: &CClockReading) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    clock.valid(),
...
pub exec fn CReplicaNextReadClockCheckForViewTimeout_opt(s: &mut CReplica, clock: &CClockReading) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    clock.valid(),
ensures
...
pub exec fn CReplicaNextReadClockCheckForQuorumOfViewSuspicions_opt(s: &mut CReplica, clock: &CClockReading) -> (sent_packets: Vec<CPacket>)
requires
    old(s).valid(),
    clock.valid(),
ensures
