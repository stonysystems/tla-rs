  ...
  public class Params
  {
    ...
    public bool Validate()
    {
      ...
      if (protocol.Length == 0) {
        Console.WriteLine("ERROR - Missing protocol parameter (use protocol=<name>)");
        Console.WriteLine("Supported protocols: rsl, twophase, leaderelection, primarybackup, chainreplication, paxos, verticalpaxos, raft, pbft, epaxos");
        return false;
      }
      return true;
    }

    public void SetHostAndPortFromIdentity(string host, int port)
    {
