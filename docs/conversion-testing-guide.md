...
#### D1 Verus Compile Baseline on Generated Specs (Phase 16.8.3d-1)
...
| `E0599` missing method on scalar | 17 |
...
Update after `16.8.3d-1` (reserved-root record-access normalization for D1 specs with no declared module variables):
- record-access chains rooted at reserved state/constant params (`s`/`s_`/`c`) are normalized in fallback mode to avoid scalar-field access failures in generated D1 modules
- compile pass remains `2/33` (`RSL/Environment.rs`, `RSL/Message.rs`)
- current first-error mix is: `0` `E0425`, `0` `E0423`, `5` `E0609`, `17` `E0599`, `5` `E0308`, `0` `E0618`, `1` `E0277`, `1` `E0061`, `2` `E0282`
