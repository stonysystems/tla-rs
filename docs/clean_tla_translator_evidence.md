...
| `t1_02_twophase` | 1 | 6 (C1,C4,C5) | **green** | pass | EQUAL | pass |
| `t2_01_raft` | 2 | 6 (C1,C3,C4,C5) | golden | pass | bounded only | pass |
| `t2_02_epaxos` | 2 | 6 (C1,C2,C4) | golden | pass | n/a | pass |
| `t3_01_jetpack` | 3 | 22 (C1,C2,C4,C5) | golden | pass | n/a | pass |
| `t4_01_jetpack_full` | 4 | 22 (C1,C2,C4,C5) | golden | pass | refinement, below | pass |
