                    ...
                    - [ ] **34.7.1.e.4.b.2.b.2.b.4.c.d.b**: Handle remaining sub-cases and resolve residual assumes in `lemma_overlap_entry_transfer_equal_term_equal_len`.
                      ...
                      - [ ] **34.7.1.e.4.b.2.b.2.b.4.c.d.b.c**: Handle **strict-term** sub-case (`req_last_log_term > voter_last_log_term`): voter's last log term at vote time was strictly less than request's last log term. Need to show leader has entry at index k.
                        ...
                        - [ ] **34.7.1.e.4.b.2.b.2.b.4.c.d.b.c.2**: Isolate the strict-term-only obligations in `lemma_overlap_entry_transfer_equal_term_equal_len` (separate from `L == 0` / `req_last_log_index > L`), proving all shared branch facts (`L >= 0`, `k < L`, packet summary alignment, `req_last_log_term > voter_vtl`) without fallback assumptions.
                          ...
                          - [ ] **34.7.1.e.4.b.2.b.2.b.4.c.d.b.c.2.b**: Refactor `lemma_overlap_entry_transfer_equal_term_equal_len` control flow to a three-way residual split with explicit strict-term guard branch and no merged fallback branch, while preserving existing equal-term-equal-length proof path.
