...
1. Eliminate remaining 7 IO trust boundary assumes (requires IO layer verification)
2. Phase 14: Regeneration audit — freshly regenerate all protocols and diff against current generated code
