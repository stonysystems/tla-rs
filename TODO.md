...
✅ **583 verified, 0 errors** (~216 assumes remaining, was ~244). Phase 12.1 complete — all simple protocol proofs done (TwoPhase + LeaderElection + Paxos = 28 assumes eliminated).
...
**12.4.1: Generate proofs for ChainReplication (14 assumes)**
- [ ] Apply transpiler proof generation to `chain_gen.rs`
- [ ] Handle chain-specific patterns (Vec operations, node ordering)
- [ ] Run Verus — target: 0 assumes remaining in ChainReplication
...
| 12.4 | Raft + ChainReplication proofs | 34 | ❌ TODO |
