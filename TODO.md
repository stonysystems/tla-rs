...
1. ~~Eliminate remaining IO trust boundary assumes~~ Decomposed to 10 uniform packet-identity assumes — irreducible without IO architecture change. See `docs/dev/io-trust-boundary-analysis.md`.
...
**All remaining open items are blocked or deferred** — the 10 packet-identity assumes are the irreducible IO trust boundary (would require restructuring the IO architecture to eliminate).
