...
1. **Phase 18: Replace flattened msgs_* fields with sent_packets output parameters** — 8 protocols have ~68 msgs_* fields creating ~1,269 LOC of frame-condition boilerplate. Refactor to use RSL-style `sent_packets` output parameter pattern. See Phase 18 section below.
...
**Active work**: Phase 18 — Replace flattened msgs_* with sent_packets. 1288 total tests (976 unit + 122 integration + 53 tla_examples + 43 roundtrip + 38 roundtrip_test + 19 regression + 14 negative + 12 pipeline_e2e + 11 main), 0 warnings.
...
- [ ] **18.2.1** TwoPhase (3 fields, simplest — validates the pattern)
