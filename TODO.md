...
- [x] **38.8.2**: Second milestone: source-DPOR style backtrack/source-set insertion with exact verdict parity against the baseline on the small cases. **DONE**: 1/2 baseline-feasible cases at exact parity (APlusB 21==21). All sub-tasks b-h complete. 38.8.2.a (raise pass floor) remains open as ongoing work tracked in blocker ledger.
