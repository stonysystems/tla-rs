...
#   - TwoPhase, Paxos, LeaderElection, Raft, ChainReplication, PrimaryBackup (simple protocols)
...
case "$TARGET" in
    ...
    *)
        ...
        echo "Usage: $0 [TwoPhase|Paxos|LeaderElection|Raft|ChainReplication|PrimaryBackup|RSL|all]"
        exit 1
        ;;
esac
